...
export function Analysis() {
  ...
  return (
    <div className="theme-dark flex h-full min-h-full flex-col justify-center bg-[var(--color-bg)] px-6 text-[var(--color-text)]">
        ...
        {STEPS.map((label, i) => {
          ...
          return (
            <div key={label} className="flex items-center gap-3">
              <span className={done ? 'text-[var(--color-positive)]' : active ? 'text-[var(--color-accent)]' : 'text-[var(--color-muted)]'}>
