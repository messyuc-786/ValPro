...
const controlClass =
  'w-full rounded-[3px] border border-[var(--color-line-strong)] bg-[var(--color-surface)] px-3.5 py-3 text-[15px] text-[var(--color-text)] outline-none placeholder:text-[var(--color-muted)] focus:border-[var(--color-accent-blue)]'
  ...
  return (
    <div className="flex items-center justify-between gap-3 py-1">
      ...
      <button
        ...
        className={`relative h-6 w-11 shrink-0 rounded-full transition-colors ${checked ? 'bg-[var(--color-accent-blue)]' : 'bg-[var(--color-line-strong)]'}`}
      >
        <span
